...
values ('held_replay', 'rollback_blocker', :'outcome'::jsonb);

select pg_advisory_lock_shared(721501000003::bigint);
select pg_advisory_unlock_shared(721501000003::bigint);
